		...
		<table width="100%">
			<tr>
				<td style="background:lightblue;" width="150px;">
					...
					<h2 style="float:right; margin: 10px 0; padding: 0 20px; color: #fff;">CMS</h2>
				</td>
				<td style="background:lightblue;">
					<a style="color: #fff; text-decoration: none; " href="/admin">HomePejcz</a>
					<a style="color: #fff; text-decoration: none; " href="/admin/blocks"> Bloki </a>
				</td>
			</tr>
			<tr>
