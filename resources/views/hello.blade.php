...
<body>
	<div class="welcome">
		...
		<table width="100%">
			<tr>
				<td style="background:pink;" colspan="2">Region 1 <br/>{!! $region1 !!}</td>
			</tr>
			<tr>
				<td style="background:yellow;" colspan="2">Region 2 <br/> {!! $region2 !!}</td>
			</tr>
			<tr>
				<td style="background:lightblue;" >Region 3 <br/>{!! $region3 !!}</td>
				<td style="background:lightgreen;" >Region 4 <br/>{!! $region4 !!}</td>
			</tr>
			<tr>
				<td style="background:red;" colspan="2">Region 5 <br/> {!! $region5 !!}</td>
			</tr>
		</table>
	</div>
</body>
